...
const DetailWisataMaimun = () => {
  const wisata = dataTempatWisata[0];
  const galeryImg = dataTempatWisata[0].gallery;
  console.log(wisata);
  return (
...
export default DetailWisataMaimun;
